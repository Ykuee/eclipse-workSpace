			...
			<div class="content">
				...
				<div class="public-header-admin fr">
					...
					<div class="public-header-fun fr">
						<a href="" class="public-header-man">管理</a> <a href=""
	...
	<div class="public-ifame mt20">
		<div class="content">
				...
				<ul class="left-nav-list">
					<li class="public-ifame-item"><a href="javascript:;">系统管理</a>
						<div class="ifame-item-sub">
							<ul>
								<li class="active"><a href="系统管理/config.jsp"
									target="content">用户信息修改</a></li>
								<li><a href="系统管理/orderlist.jsp" target="content">订单管理</a></li>
								<li><a href="" target="content">名片模板管理</a></li>
								<li><a href="系统管理/index_tj.html" target="content">首页推荐导航</a></li>
							</ul>
						</div></li>
					<li class="public-ifame-item"><a href="javascript:;">信息管理</a>
						<div class="ifame-item-sub">
							<ul>
								<li><a href="信息管理/article_manage.html" target="content">列表管理</a>|<a
									href="信息管理/article_add.html" target="content">添加</a></li>
								<li><a href="信息管理/cate_manage.html" target="content">分类管理</a></li>
							</ul>
						</div></li>
					<li class="public-ifame-item"><a href="javascript:;">旅游套餐</a>
						<div class="ifame-item-sub">
							<ul>
								<li><a href="旅游管理/lytc_manage.html" target="content">信息列表</a>|<a
									href="#" target="content">添加</a></li>
			...
			<div class="public-ifame-content">
				<iframe name="content" src="main.jsp" frameborder="0"
